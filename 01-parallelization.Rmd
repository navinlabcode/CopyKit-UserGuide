...
register(MulticoreParam(workers = 100, progressbar = T), default = T)
```
...
BiocParallel registered 100 processes for parallelization of copykit functions. The default parameter can be confirmed with:
```{r default}
